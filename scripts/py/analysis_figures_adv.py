...
out1 = os.path.join(FIG_DIR, "gdp_growth_boxplots.png")
...
out2 = os.path.join(FIG_DIR, "gdp_pc_vs_employment_scatter.png")
...
out3 = os.path.join(FIG_DIR, "growth_employment_correlation.png")
